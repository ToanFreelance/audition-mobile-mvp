...
const REFERENCE_AUDIO_SRC = "/audio/Please%20tell%20me%20why.mp3";
...
export class RhythmRuntime {
  ...
  private commandCursor = 0; private timingMoveIndex = 0; private started = false; private finished = false; private raf = 0; private lastStatsSignature = ""; private timeSource: ClockTimeSource | null = null; private referenceAudio: HTMLAudioElement | null = null;
  ...
  private advanceAfterJudgement(judgement: Judgement) { this.timingMoveIndex += 1; this.callbacks.onJudgement?.(judgement); this.callbacks.onPulse?.(); this.emitStats(true); if (this.timingMoveIndex >= this.totalMoves) { this.finished = true; this.callbacks.onFinished?.(cloneStats(this.engine.stats)); this.referenceAudio?.pause(); } }
